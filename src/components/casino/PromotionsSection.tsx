...
export function PromotionsSection() {
  const promos = [
    ...
    },
    {
      ...
      title: "MINES TACTICAL SHOWCASE",
      description: "Experience minefield grid mechanics with configurable mine density and instantaneous simulated cash-out response.",
      cta: "Launch Mines Demo",
      href: "/games/mines",
